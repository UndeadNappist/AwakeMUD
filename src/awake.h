...
#define PLR_RPE 37
#define PLR_NO_IDLE_OUT                                                        \
  38 /* Player will not idle out (morts- for test chars) */
#define PLR_MAX 39
...
// If you add to this list, also add the name of your new log type to
// constants.cpp's log_types[].
...
// Defines the size of the teach_t array. Changing this means you have to change
// every teacher too.
...
#define ITEM_HARDENED_ARMOR                                                    \
  25 // Applies hardened armor rules (deflect attacks with power <= armor
     // rating) CC p51
...
// Everything past this line is assumed to be cultured by default. If you add
// more that's not cultured, change the cultured check in db.cpp.
...
#define MAX_SOCK_BUF                                                           \
  (22 * 1024) /* Size of kernel's sock buf   */ // was 12 * 1024, increased
                                                // arbitrarily
...
#define MAX_PWD_LENGTH                                                         \
  30 /* Relic of the past, do not change. Dictates max length of crypt()       \
        hashes. */
...
// This is specifically not included in the above since not every vehicle can
// leave it successfully. BIKES AND DRONES ONLY.
...
// Note: If you change this, you'll have to update zone file loading etc as
// well.
...
// Bigint takes 2^63-1 signed, 2^64-1 unsigned. You probably don't need to care
// about it.
