...
const char *status_ratings[] = {"Nonexistent", "Mortal",    "Builder",
                                "Architect",   "Fixer",     "Conspirator",
                                "Executive",   "Developer", "Vice-President",
                                "Admin",       "President", "\n"};

const char *patch_names[] = {"antidote", "stimulant", "tranq", "trauma"};

const char *dist_name[] = {"close by", "not far off", "in the distance",
                           "almost out of sight"};

const char *wound_arr[] = {"None",  "L",     "M",     "S",     "D",
                           "BUGD1", "BUGD2", "BUGD3", "BUGD4", "BUGD5"};

const char *wound_name[] = {
    "None", "Light",      "Moderate",   "Serious",    "Deadly",
    "\n",   "BUGDeadly2", "BUGDeadly3", "BUGDeadly4", "BUGDeadly5"};
...
const char *material_names[] = {"paper",       "wood",
                                "glass",       "fabric",
                                "leather",
                                "brick", // 5
                                "plastic",     "adv. plastics",
                                "metal",       "orichalcum",
                                "electronics", // 10
                                "computers",   "toxic wastes",
                                "organic",     "stone",
                                "ceramic", // 15
                                "concrete",    "\n"};

const char *barrier_names[] = {"Standard glass",
                               "Cheap material",
...
int barrier_ratings[] = {2, 3, 4, 6, 8, 12, 16, 24, 32};

/* cardinal directions */
const char *dirs[] = {"north", "ne", "east", "se",   "south", "sw",
                      "west",  "nw", "up",   "down", "\n"};

const char *exitdirs[] = {"n", "ne", "e", "se", "s", "sw",
                          "w", "nw", "u", "d",  "\n"};

const char *lookdirs[] = {"north", "east", "south", "west", "ne", "se",
                          "sw",    "nw",   "up",    "down", "\n"};
...
int convert_dir[] = {1, 7, 2, 8, 3, 9, 4, 10, 5, 6, 0};

const char *fulldirs[] = {"north", "northeast", "east", "southeast",
...
/* ROOM_x */
const char *room_bits[] = {"DARK",       "DEATH",          "!MOB",
                           "INDOORS",    "PEACEFUL",       "SOUNDPROOF",
                           "!TRACK",     "!MAGIC",         "TUNNEL",
                           "ARENA",      "STREETLIGHTS",   "HOUSE",
                           "HCRSH",      "ATRIUM",         "OLC",
                           "*", /* BFS MARK */
                           "LOW_LIGHT",
                           "!USED", // Empty slot.
                           "!RADIO",     "!BIKE",          "!WALK",
                           "FALL",       "ROAD",           "GARAGE",
                           "STAFF-ONLY", "!QUIT",          "SENT",
                           "ASTRAL",     "!GRID",          "STORAGE",
                           "!TRAFFIC",   "ELEVATOR_SHAFT", "\n"};
...
const char *thrdgenders[] = {"it", "him", "her", "\n"};

struct spirit_table spirits[] = {
    {"Hearth spirit", 30}, {"City spirit", 29},   {"Field spirit", 31},
    {"Forest spirit", 33}, {"Desert spirit", 32}, {"Mountain spirit", 34},
    {"River spirit", 39},  {"Sea spirit", 40},    {"Prairie spirit", 35},
    {"Mist spirit", 36},   {"Storm spirit", 37},  {"Wind spirit", 42},
    {"Lake spirit", 38},   {"Swamp spirit", 41}};

const char *spirit_name[] = {"Inside",   "City",  "Field", "Forest",  "Desert",
                             "Mountain", "River", "Sea",   "Prairie", "Mist",
                             "Storm",    "Wind",  "Lake",  "Swamp",   "\n"};

const char *spirit_powers[] = {
    "accident", "alienate", "aura", "bind",  "breathe",  "conceal", "confuse",
    "engulf",   "fear",     "find", "guard", "manifest", "project"};

/* POS_x */
const char *position_types[] = {
    "Dead",    "Mortally wounded", "Stunned",  "Sleeping", "Lying",
    "Resting", "Sitting",          "Fighting", "Standing", "\n"};

const char *attack_types[] = {"Hit",
                              "Sting",
                              "Whip",
                              "Slash",
                              "Bite",
...
const char *weapon_type[] = {"edged weapon",
                             "club",
                             "pole arm",
                             "whip",
                             "glove",
...
const char *player_bits[] = {
    "KILLER",  "BLACKLIST", "FROZEN",  "DONTSET",      "NEWBIE",    "JUST_DIED",
    "VISA",    "!USED",     "SITEOK",  "!SHOUT",       "!TITLE",    "DELETED",
    "!DELETE", "PACKING",   "!STAT",   "LOADRM",       "INVST",     "!USED",
    "!USED",   "OLC",       "MATRIX",  "PERCEIVE",     "PROJECT",   "SWITCHED",
    "WRITING", "MAILING",   "EDITING", "SPELL-CREATE", "CUSTOMIZE", "!SNOOP",
    "WANTED",  "NOOOC",     "!AUTH",   "EDITCON",      "REMOTE",    "INIT",
    "DRIVEBY", "RPE",       "\n"};

/* MOB_x */
const char *action_bits[] = {
    "SPEC",         "SENTINEL",    "SCAVENGER",   "ISNPC",
    "AWARE",        "AGGR",        "STAY-ZONE",   "WIMPY",
    "AGGR_ORK",     "AGGR_ELF",    "AGGR_DWARF",  "MEMORY",
    "HELPER",       "!RAM",        "DUAL",        "!EXPLODE",
    "AGGR_TROLL",   "!BLIND",      "ASTRAL",      "GUARD",
    "AGGR_HUMAN",   "SNIPER",      "PRIVATE",     "TRACK",
    "FLAMEAURA",    "SPIRITGUARD", "SPIRITSTUDY", "SPIRITSORCERY",
    "AZTECHNOLOGY", "RENRAKU",     "!KILL",       "TOTALINVIS",
    "INANIMATE",    "\n"};

/* PRF_x */
const char *preference_bits[] = {
    "PACIFY",    "COMPACT",      "AUTOEX",       "FIGHTGAG",  "MOVEGAG",
    "DEAF",      "!TELL",        "!RADIO",       "!NEWBIE",   "!REPEAT",
    "HARDCORE",  "PKER",         "QUEST",        "AFK",       "C1",
    "C2",        "NOHASSLE",     "ROOMFLAGS",    "HOLYLIGHT", "CONNLOG",
    "DEATHLOG",  "MISCLOG",      "WIZLOG",       "SYSLOG",    "ZONELOG",
    "LONGEXIT",  "ROLLS",        "!OOC",         "AUTOINVIS", "CHEATLOG",
    "ASSIST",    "BANLOG",       "!RPE",         "!HIRED",    "GRIDLOG",
    "WRECKLOG",  "QUESTOR",      "NEWBIEHELPER", "MENUGAG",   "LONGWEAPON",
    "PGROUPLOG", "SHOWGROUPTAG", "KEEPALIVE",    "HELPLOG",   "PURGELOG",
    "\n"};

/* AFF_x */
const char *affected_bits[] = {"NOTHING",        "Ruthenium",
                               "Banishing",      "Det-invis",
                               "Prone",          "Manifest",
                               "Healed",         "Group",
                               "Damaged",        "Infravision",
                               ...
                               "Charm",          "ACTION",
                               "Vision x2",      "Vision x3",
                               "COUNTERATTACK",  "Stabilize",
                               "Petrify",        "Thermoptic",
                               "Acid",           "APPROACH",
                               "Pilot",          "Rigger",
                               "Manning",        "Designing",
                               "Programming",    "Part Designing",
                               "Part Building",  "Withdrawal (Forced)",
                               "Withdrawal",     "Bonding Focus",
                               "Conjuring",      "Building Lodge",
                               "Drawing Circle", "Packing Workshop",
                               "Invis (Spell)",  "ImpInvis (Spell)",
                               "Tracking",       "Tracked",
                               "Binding",        "Spell Design",
                               "Surprised",      "Ammo Building"};

/* CON_x */
const char *connected_types[] = {"Playing", // 0
                                 "Disconnecting",
                                 "Get name",
                                 "Confirm name",
                                 "Get password",
...
/* WEAR_x - for eq list */
const char *where[] = {
    "<used as light>      ", "<worn on head>       ", "<eyes>               ",
    "<ear>                ", "<ear>                ", "<worn on face>       ",
    "<worn around neck>   ", "<worn around neck>   ", "<worn over shoulder> ",
    "<worn about body>    ", "<worn on body>       ", "<worn underneath>    ",
    "<worn on arms>       ", "<slung under arm>    ", "<slung under arm>    ",
    "<worn around wrist>  ", "<worn around wrist>  ", "<worn on hands>      ",
    "<wielded>            ", "<held>               ", "<worn as shield>     ",
    "<worn on finger>     ", "<worn on finger>     ", "<worn on finger>     ",
    "<worn on finger>     ", "<worn on finger>     ", "<worn on finger>     ",
    "<worn on finger>     ", "<worn on finger>     ", "<belly button>       ",
    "<worn about waist>   ", "<worn on thigh>      ", "<worn on thigh>      ",
    "<worn on legs>       ", "<worn around ankle>  ", "<worn around ankle>  ",
    "<worn as socks>      ", "<worn on feet>       ", "<patch>              "};
...
const char *short_where[] = {
    "LIGHT",   "HEAD",    "EYES",    "EAR1",    "EAR2",    "FACE",    "NECK1",
    "NECK2",   "BACK",    "ABOUT",   "BODY",    "UNDER",   "ARMS",    "ARM1",
    "ARM2",    "R_WRIST", "L_WRIST", "HANDS",   "WIELD",   "HELD",    "SHIELD",
    "FINGER1", "FINGER2", "FINGER3", "FINGER4", "FINGER5", "FINGER6", "FINGER7",
    "FINGER8", "BELLY",   "WAIST",   "THIGH1",  "THIGH2",  "LEGS",    "ANKLE1",
    "ANKLE2",  "SOCK",    "FEET",    "PATCH"};
...
const char *wear_bits[] = {
    ...
    "HOLD",  "EYES",   "EAR",    "UNDER", "BACK",  "ANKLE", "SOCK",
    "BELLY", "ARM",    "FACE",   "THIGH", "PATCH", "\n"};

/* ITEM_x (extra bits) */
const char *extra_bits[] = {
    "GLOW",           "HUM",      "!RENT",     "!DONATE",      "!INVIS",
    "INVISIBLE",      "MAGIC",    "!DROP",     "FORMFIT",      "!SELL",
    "CORPSE",         "GOD_ONLY", "TWO_HANDS", "COMPLEXBURST", "VOLATILE",
    "WIZLOAD",        "NOTROLL",  "NOELF",     "NODWARF",      "NOORK",
    "NOHUMAN",        "SNIPER",   "IMMLOAD",   "NERPS",        "BLOCKS_ARMOR",
    "HARDENED_ARMOR", "\n"};

/* APPLY_x */
const char *apply_types[] = {"Nothing",
                             "Body",
                             "Quickness",
                             "Strength",
                             "Charisma",
...
struct program_data programs[] = {{"None", 0},
                                  {"Bod", 3},
                                  {"Evasion", 3},
                                  {"Masking", 2},
                                  {"Sensor", 2},
...
const char *log_types[] = {"CONNLOG", "DEATHLOG", "MISCLOG",  "WIZLOG",
                           "SYSLOG",  "ZONELOG",  "CHEATLOG", "WIZITEMLOG",
                           "BANLOG",  "GRIDLOG",  "WRECKLOG", "PGROUPLOG",
                           "HELPLOG", "PURGELOG", "\n"};
...
const char *drinknames[] = {
    "water",  "soda",      "coffee",      "milk",       "juice",    "tea",
    "soykaf", "smoothie",  "sportsjuice", "espresso",   "beer",     "ale",
    "lager",  "import",    "microbrew",   "maltliquor", "cocktail", "margarita",
    "liquor", "vodka",     "tequila",     "brandy",     "rum",      "whiskey",
    "gin",    "champagne", "redwine",     "whitewine",  "blood",    "hotsauce",
    "piss",   "local",     "fuckup",      "\n"};
...
int rev_dir[] = {4, 5, 6, 7, 0, 1, 2, 3, 9, 8};
...
const char *veh_type[11] = {
    "Drone",           "Bike",          "Car",        "Truck",     "Fixed Wing",
    "Rotorcraft",      "Vector Thrust", "Hovercraft", "Motorboat", "Ship",
    "Lighter Than Air"};
...
const char *mod_name[NUM_MODS] = {"NOWHERE",
                                  "Intake (Front)",
                                  "Intake (Mid)",
                                  "Intake (Rear)",
                                  "Engine",
...
const char *engine_type[6] = {"Nothing",  "Electric", "Fuel Cell",
                              "Gasoline", "Methane",  "Diesel"};

const char *veh_aff[] = {
    "Nothing", "Handling", "Speed",   "Acceleration",    "Body",
    "Armor",   "Sig",      "Autonav", "Seating (Front)", "Seating (Rear)",
    "Load",    "Sensors",  "Pilot",
};

const char *veh_flag[] = {"Nothing", "Can Fly", "Amphibious", "Workshop",
                          "Newbie"};

const char *jurid[] = {"Seattle", "Portland", "Caribbean", "Ocean", "\n"};

const char *host_sec[] = {"^BBlue", "^GGreen", "^YOrange", "^RRed", "^LBlack"};

const char *host_type[] = {"Datastore", "LTG",      "RTG",
                           "PLTG",      "Security", "Controller"};

const char *intrusion[] = {"Easy", "Average", "Hard"};

const char *alerts[] = {"No Alert", "Passive", "Active", "Shutdown"};

const char *ic_type[] = {"^WCrippler^n",
                         "^WKiller^n",
                         "^WProbe^n",
                         "^WScramble^n",
                         "^WTar Baby^n",
...
const char *ic_option[] = {
    "UNDEF",          "ARMOUR", "CASCADING", "EXPERT DEFENSE",
    "EXPERT OFFENSE", "SHIELD", "SHIFT",     "TRAP"};

const char *ic_option_long[] = {"Undefined",
                                "Armour, ",
                                "Cascading Attack, ",
                                "Expert Defense, ",
                                "Expert Offense, ",
...
struct ammo_data ammo_type[] = {
    ...
    {"normal", 2, 1, .25, 2, .75},     {"APDS", 14, 14, .25, 7, 4},
    {"explosive", 3, 1.5, .75, 5, .8}, {"EX", 6, 3, .75, 10, 1.5},
    {"flechette", 3, 1.5, .5, 10, .8}, {"gel", 4, 2, .25, 3, 1}};

const char *positions[] = {
    " is lying here, dead",    " is lying here, mortally wounded",
    " is lying here, stunned", " is sleeping here",
    " is lying here",          " is resting here",
    " is sitting here",        "!FIGHTING!",
    " is standing here"};
...
const char *attributes[] = {"Body",         "Quickness", "Strength", "Charisma",
                            "Intelligence", "Willpower", "Reaction"};

const char *short_attributes[] = {"bod", "qui", "str", "cha",
                                  "int", "wil", "rea"};

struct drug_data drug_types[] = {{"Nothing", 0, 0, 0, 0, 0, 0, 0, 0},
...
struct spell_types spells[] = {
    ...
    {"Decrease Cybered Attribute", TRUE, HEALTH, SINGLE, -1, SUSTAINED, 2,
     SERIOUS},
    ...
    {"Increase Cybered Attribute", TRUE, HEALTH, SINGLE, -1, SUSTAINED, 2,
     MODERATE},
    {"Increase Reaction", FALSE, HEALTH, SINGLE, ATT_REA, SUSTAINED, 1,
     SERIOUS},
    {"Increase Reflexes +1", FALSE, HEALTH, SINGLE, ATT_REA, SUSTAINED, 1,
     SERIOUS},
    {"Increase Reflexes +2", FALSE, HEALTH, SINGLE, ATT_REA, SUSTAINED, 1,
     DEADLY},
    {"Increase Reflexes +3", FALSE, HEALTH, SINGLE, ATT_REA, SUSTAINED, 3,
     DEADLY},
    ...
    {"Improved Invisibility", TRUE, ILLUSION, SINGLE, -1, SUSTAINED, 1,
     MODERATE},
...
const char *totem_types[] = {
    "UNDEFINED",   "Bear",      "Buffalo", "Cat",      "Coyote",  "Dog",
    "Dolphin",     "Eagle",     "Gator",   "Lion",     "Mouse",   "Owl",
    "Raccoon",     "Rat",       "Raven",   "Shark",    "Snake",   "Wolf",
    "Badger",      "Bat",       "Boar",    "Bull",     "Cheetah", "Cobra",
    "Crab",        "Crocodile", "Dove",    "Elk",      "Fish",    "Fox",
    "Gecko",       "Goose",     "Horse",   "Hyena",    "Jackal",  "Jaguar",
    "Leopard",     "Lizard",    "Monkey",  "Otter",    "Parrot",  "Polecat",
    "Prairie dog", "Puma",      "Python",  "Scorpion", "Spider",  "Stag",
    "Turtle",      "Whale"};

const char *spell_category[6] = {"UNDEF",  "Combat",   "Detection",
                                 "Health", "Illusion", "Manipulation"};

const char *durations[3] = {"Instant", "Sustained", "Permanent"};

struct spirit_table elements[4] = {
    {"Earth", 26}, {"Fire", 27}, {"Air", 25}, {"Water", 28}};

const char *foci_type[] = {"expendable", "specific spell", "category", "spirit",
                           "power",      "sustaining",     "weapon"};

const char *ranges[4] = {"Single", "Area", "Touch", "Caster Only"};
const char *light_levels[] = {"Normal",
...
const char *room_types[] = {"City Street",
                            "Suburban Street",
                            "Highway",
                            "Field",
                            "Forest",
...
const char *cyber_grades[4] = {"Standard", "Alpha", "Beta", "Delta"};

const char *eyemods[] = {"Camera",
                         "Cyber Replacement",
                         "Display Link",
                         "Flare Compensation",
                         "Image Link",
...
const char *decap_cyber_grades[4] = {"standard", "alpha", "beta", "delta"};

const char *bone_lacing[5] = {"Plastic", "Aluminium", "Titanium", "Kevlar",
                              "Ceramic"};

const char *hand_razors[3] = {"Retractable", "Improved", "\n"};
const char *cyber_types[] = {"Chipjack",
                             "Datajack",
                             "Datalock",
                             "Knowsoft Link",
                             "Memory",
...
const char *decap_cyber_types[] = {"chipjack",
                                   "datajack",
                                   "datalock",
                                   "knowsoft link",
                                   "memory chip",
...
const char *bio_types[] = {
    "Adrenal Pump",          "Cat's Eyes",          "Digestive Expansion",
    "Enhanced Articulation", "Extended Volume",     "Metabolic Arrestor",
    "Muscle Augmentation",   "Muscle Toner",        "Nephritic Screen",
    "Nictitating Gland",     "Orthoskin",           "Pathogenic Defense",
    "Platelet Factory",      "Suprathyroid Gland",  "Symbiotes",
    "Synthacardium",         "Tailored Pheremones", "Toxin Extractor",
    "Tracheal Filter",       "Cerebral Booster",    "Damage Compensator",
    "Pain Editor",           "Reflex Recorder",     "Synaptic Accelerator",
    "Thermosense Organs",    "Trauma Dampener"};

const char *decap_bio_types[] = {"adrenal pump",
                                 "pair of cat's eyes",
                                 "digestive expansion",
...
const char *metamagic[] = {"Anchoring",  "Centering",  "Cleansing",
                           "Invoking",   "Masking",    "Possessing",
                           "Quickening", "Reflecting", "Shielding"};

const char *legality_codes[][2] = {{"*", "Nothing"},
                                   {"A", "Small Blade"},
                                   {"B", "Large Blade"},
                                   {"C", "Blunt Weapon"},
                                   {"D", "Projectile"},
...
const char *background_types[] = {
    "violence",      "torture",   "hatred",     "genocide",
    "ritual magic",
    "sacrifice", // 5
    "worship",       "death",     "pollution",  "concentrated magic",
    "lost humanity", // 10
    "sterility",     "confusion", "power site", "blood magic",
    "violence", // 15
    "death"};

const char *fire_mode[] = {"NOTHING", "Single Shot", "Semi-Automatic",
                           "Burst Fire", "Full Automatic"};

const char *combat_modifiers[] = {"Recoil",   "Movement",   "2Weap",    "Smart",
                                  "Distance", "Visibility", "Position", "Gyro",
                                  "Reach",    "VehDamaged"};

const char *pgroup_privileges[] = {
    "Administrator", "Auditor", "Architect", "Co-Conspirator", "Driver",
    "Landlord",      "Leader",  "Manager",   "Mechanic",       "Procurer",
    "Recruiter",     "Tenant",  "Treasurer"};

const char *workshops[] = {"General",   "Electronics", "Microtronics",
                           "Cyberware", "Vehicle",     "Weaponry",
                           "Medical",   "Ammunition"};

const char *projectile_ammo_types[] = {"Arrow", "Bolt", "Shuriken",
                                       "Throwing Knife"};

const char *magic_tool_types[] = {"Conjuring Library", "Sorcery Library",
                                  "Hermetic Circle", "Shamanic Lodge",
                                  "Summoning Materials"};

const char *holster_types[] = {"Pistol / SMG", "Sword", "Rifle (or larger)"};

const char *docwagon_contract_types[] = {
    "Bugged (alert an imm)", // undefined / 0
    "Basic", "Gold", "Platinum"};

const char *gun_accessory_locations[] = {"top", "barrel", "underside"};

const char *gun_accessory_types[] = {
    "Undefined", "Smartlink",        "Scope",         "Gas Vent", "Shock Pad",
    "Silencer",  "Sound Suppressor", "Smart Goggles", "Bipod",    "Tripod",
    "Bayonet"};

const char *mount_types[] = {"Firmpoint Internal Fixed Mount",
...
const char *deck_accessory_upgrade_types[] = {
    "MPCP (replacement)", "Active Memory", "Storage Memory",
    "Hitcher Jack",       "I/O Speed",     "Reaction Increase"};

const char *message_history_channels[] = {
    "Hired", "Newbie", "OOC",  "OSays",  "Pages", "Phone",
    "RPE",   "Radio",  "Says", "Shouts", "Tells", "Wiztells"};

const char *pgroup_settings[] = {"Founded", "Disabled", "Clandestine",
                                 "Cloned / temporary"};

int acceptable_weapon_attachment_affects[] = {
    AFF_LASER_SIGHT, AFF_VISION_MAG_1, AFF_VISION_MAG_2, AFF_VISION_MAG_3,
    AFF_INFRAVISION, AFF_LOW_LIGHT,    AFF_DETECT_INVIS, -1};
