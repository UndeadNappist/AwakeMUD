extern struct char_data *create_elemental(struct char_data *ch, int type,
                                          int force, int idnum, int tradition);
...
extern void totem_bonus(struct char_data *ch, int action, int type, int &target,
                        int &skill);
extern void mob_cast(struct char_data *ch, struct char_data *tch,
                     struct obj_data *tobj, int spellnum, int level);
extern void end_sustained_spell(struct char_data *ch,
...
extern void elemental_fulfilled_services(struct char_data *ch,
