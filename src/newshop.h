...
struct shop_data {
  ...
  char *no_such_itemk, *no_such_itemp, *not_enough_nuyen, *doesnt_buy, *buy,
      *sell, *shopname;
  ...
  shop_data()
      : no_such_itemk(NULL), no_such_itemp(NULL), not_enough_nuyen(NULL),
        doesnt_buy(NULL), buy(NULL), sell(NULL), shopname(NULL), selling(NULL),
        order(NULL) {}
};
