...
// Change this value to determine how many seconds you're willing to have the
// MUD hang for each hash.
#define ACCEPTABLE_HASH_TIME_IN_SECONDS 1.5

// Warning: Changing these will not affect the hashing speed of old password
// hashes. It may also break old hashes, this has not been tested.
